...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_new_tags(self):
        ...
        payload = {
            "title": "Shekh Al Mehshi",
            "time_minutes": 60,
            "price": Decimal("2.50"),
            "tags": [{"name": "Syrian"}, {"name": "Dinner"}],
        }
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        tag_syrian = Tag.objects.create(user=self.user, name="ME")
        payload = {
            "title": "Kebbeh",
            "time_minutes": 120,
            "price": Decimal("9.50"),
            "tags": [{"name": "ME"}, {"name": "Dinner"}],
        }
        res = self.client.post(RECIPE_URL, payload, format="json")
        ...
        recipe = recipes[0]
        self.assertEqual(recipe.tags.count(), 2)
        self.assertIn(tag_syrian, recipe.tags.all())
        for tag in payload["tags"]:
            exists = recipe.tags.filter(
                name=tag["name"],
                user=self.user,
    ...
    def test_filter_by_tag(self):
        ...
        r2 = create_recipe(user=self.user, title='Eggplants with Tahini')
